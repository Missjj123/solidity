...
At least a day before the release:
 ...
 - [ ] Rerun CI on the top commits of main branches in all repositories that do not have daily activity by creating a test branch or PR:
      ...
      - [ ] ``homebrew-ethereum``
 - [ ] Create a prerelease in our Ubuntu PPA by following the steps in the PPA section below on ``develop`` rather than on a tag.
...
### PPA
 ...
 - [ ] Wait for the build to be finished and published for *all architectures*.
